...
// ── Turnos ────────────────────────────────────────────────────────────────────
router.get('/turnos', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.get('/turnos/:id', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.post('/turnos', auth_middleware_1.requireAuth, (0, permission_middleware_1.requirePermission)('config.sistema'), async (req, res, next) => {
    try {
...
router.put('/turnos/:id', auth_middleware_1.requireAuth, (0, permission_middleware_1.requirePermission)('config.sistema'), async (req, res, next) => {
    try {
...
router.delete('/turnos/:id', auth_middleware_1.requireAuth, (0, permission_middleware_1.requirePermission)('config.sistema'), async (req, res, next) => {
    try {
...
// ── Cierres ───────────────────────────────────────────────────────────────────
router.get('/cierres', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.get('/cierres/:id', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.post('/cierres/iniciar', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
        ...
        // Si el error contiene ordenes_abiertas lo devolvemos con 409
...
router.post('/cierres/:id/confirmar', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
