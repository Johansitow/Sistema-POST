...
// Verificar stock de ingredientes para una orden (antes de marcar ENTREGADA)
// Va primero para no colisionar con /:id
router.post('/verificar-stock/:id_orden', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.get('/producto/:id_producto', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.get('/:id/rentabilidad', auth_middleware_1.requireAuth, async (req, res, next) => {
    try {
...
router.post('/', auth_middleware_1.requireAuth, (0, permission_middleware_1.requirePermission)('productos.crear'), async (req, res, next) => {
    try {
...
router.put('/:id', auth_middleware_1.requireAuth, (0, permission_middleware_1.requirePermission)('productos.editar'), async (req, res, next) => {
    try {
        const { ingredientes, ...resto } = req.body;
...
router.put('/:id/ingredientes', auth_middleware_1.requireAuth, (0, permission_middleware_1.requirePermission)('productos.editar'), async (req, res, next) => {
    try {
